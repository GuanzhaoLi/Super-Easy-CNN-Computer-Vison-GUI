...
def _main(modelNameSave, modelNameOpen):
    ...
    if is_tiny_version:
        ...
        model = create_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='model_data/'+modelNameOpen+'.h5') # make sure you know what you freeze
    ...
    if True:
        ...
        model.save_weights('model_data/ '+ modelNameSave+'.h5')
